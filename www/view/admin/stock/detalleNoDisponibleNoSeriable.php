                ...
                <div class="panel-body">
                    <table class="table table-bordered table-condensed table-striped small">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $noDisponible['ticket']; ?></td>
                                <td><?php echo $noDisponible['categoria']; ?></td>
                                <td><?php echo $noDisponible['marca']; ?></td>
                                <td><?php echo $noDisponible['modelo']; ?></td>
                                <td><?php echo $noDisponible['cantidad']; ?></td>
                                <td><?php echo $noDisponible['estado']; ?></td>
                                <td class="text-center"><a
                                        href="<?php url($noDisponible['tipo_movimiento'] . "/informe/" . $noDisponible['id'])?>"
                                        target="_blank"><i class="fa fa-search text-primary"></i></a></td>
                            </tr>
                            <?php }?>
                        </tbody>
                    </table>
