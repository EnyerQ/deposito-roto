...
<div id="wrapper">
    ...
    <div id="page-wrapper" ng-app="DetalleAPP" ng-controller="DetalleControlador">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><?php echo isset($traslado) ? 'Actualizar':'Nueva' ?> traslado |
        ...
        <!--INICIO CONTENIDO-->
        <form action="<?php url("traslado/agregar") ?>" id="registrar" method="post" role="form">
            <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="col-md-6">
                            <?php if (isset($traslado)) { ?>
                                <input type="hidden" value="<?php echo $traslado->id ?>" name="traslado_id" id="movimiento_id">
                            <?php } ?>
                            <input type="hidden" value="<?php url('') ?>" id="urlPrincipal">
                            <input type="hidden" value="<?php echo isset($traslado) ? $traslado->interviene : $_SESSION['origen'] ?>" name="interviene">

                            <div class="form-group">
                                <label for="remito">Remito o referencía</label>
                                <input value="<?php echo isset($traslado) ? $traslado->remito : '' ?>"
                                       autofocus type="text" class="form-control"
                                       name="remito" id="remito" placeholder="Número de remito" autocomplete="off">
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="<?php echo isset($traslado) ? $traslado->observacion : '' ?>"
                                       type="text" class="form-control"
                                       name="observacion" id="observacion" autocomplete="off">
                            </div>

                            <div class="form-group">
                                <label for="comentario">Comentarios:</label>
                                <textarea class="form-control" rows="5" name="comentario" id="comentario"
                                          placeholder="En caso de ser necesarío agregue aquí comentarios."><?php echo isset($traslado) ?$traslado->comentario:"" ?>
                                </textarea>
                            </div>

                            <div class="form-group">
                                <label for="ticket">Ticket u orden de compra</label>
                                <input value="<?php echo isset($traslado) ? $traslado->ticket : '' ?>"
                                       type="text" class="form-control"
                                       name="ticket" id="ticket" placeholder="Ticket u orden de compra" autocomplete="off">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="progreso" id="progreso" class="form-control"
                                    ...
                                    <option <?php echo isset($traslado) && $traslado->progreso == $progreso['id']
                        ...
                        <div class="col-md-12">
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <button ng-click="cargarDetalle()" type="button" data-toggle="modal" data-target="#listaProductos"
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr ng-repeat="pd in detallesAdd">
                                            ...
                                            <td><button ng-click="eliminarProducto(pd)" type="button"
                                                        class="btn btn-sm btn-danger"><i class="fa fa-trash-o fa-1x"></i></button>
                                                <button ng-click="verId_Modelo(pd.id,pd.model)" type="button" data-toggle="modal" data-target="#listarSeries"
                                                        class="btn btn-sm btn-success" ng-show="pd.seriable == '1'">series</button></td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
                        ...
                        <div class="col-md-6">
                            <button type="submit" id="enviar_f" class="btn btn-primary"><!--Boton de envío Formulario-->
                                <?php echo isset($traslado) ? 'Actualizar' : 'Registrar' ?></button>
                        </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-6">
                            <input type="text" placeholder="Ingresa la cantidad" class="form-control"
                                   id="cantidadP" ng-model="cantiDAD">
                        </div>
                        <table class="table table-hover">
                            <thead>
                            <tr>
                            ...
                            <tr ng-repeat="detalle in detalles | filter: buscarProducto">
                                ...
                                <td> {{detalle.model}} </td>
                                <td> {{detalle.marc}} </td>
                                <td><button ng-click="seleccionarProducto(detalle.id,detalle.model,detalle.cate)" type="button"
                                            class="btn btn-sm btn-default">Agregar</button></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <div class="modal-dialog" id="modalSerie" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input ng-model="numSerie" ng-keypress="myFunct($event)" id="nuSerie" type="text" class="form-control"/>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-12">
